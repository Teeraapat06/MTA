...
function updata ( data ) {
    ...
    var playerRadius = data[0]["playerRadius"];
    var Medic = data[0]["Medic"];

    var blood = data[0]["Blood"];
    var bloodGUI = data[0]["Blood"];
    ...
    */
    ...
    $("#id").text( PlayerName );
    $("#ambulance").text( Police );
    $("#police").text( Medic );

    $("#health-text").text( 100/maxBlood*blood );
    $("#armorlevel").text( 100/maxArmor*armor );
    $("#thealth").html( bloodGUI + "%");
    $("#health").css("width", bloodGUI + "%"); 
    $("#armor").css("width", bloodGUI + "%"); /* เกาะ  */
    ...
    $("#food").html( 100/maxFood*food + "%");
    $("#thirst").html(  100/maxThirst*thirst + "%");
    $("#stammina").html( 100/maxStammina*stammina + "%");
	...
	Progress(  100/maxThirst*thirst, ".water")
	Progress(100/maxFood*food, ".food")
}
