...
function _typeof(t) {
    ...
    var e, s, a, o, r = (e = function(t, e, i, n) {
        var r, a;
    ...
    var l, i, n, u = (l = {
        ...
        function s(t) {
            ...
            (t.circleProgress = this).doc = n, t.setAttribute("role", "progressbar"), this.el = t, i = _objectSpread(_objectSpread({}, s.defaults), i), Object.defineProperty(this, "_attrs", {
                value: {},
                enumerable: !1
        ...
        return _createClass(s, [{
            ...
            value: function() {
                ...
                }) : (this.graph.sector.attr("d", s._makeSectorPath(50, 50, a, r, i, e)), this._updateText(this.value, (2 * r + i) / 2, a)), this.graph.value = this.value)
            }
        }, {
            key: "_updateText",
    ...
    n = function(c) {
        ...
        c.cleanData = (r = c.cleanData, function(t) {
            ...
            var n, r, a, s, o = {},
                u = t.split(".")[0];
            return t = t.split(".")[1], n = u + "-" + t, e || (e = i, i = c.Widget), c.expr[":"][n.toLowerCase()] = function(t) {
                return !!c.data(t, n)
            }, c[u] = c[u] || {}, r = c[u][t], a = c[u][t] = function(t, e) {
                ...
                widgetName: t,
                widgetFullName: n
            }), r ? (c.each(r._childConstructors, function(t, e) {
                var i = e.prototype;
            ...
            c.Widget.prototype["_" + a] = function(e, t, i) {
                ...
                var n, r = t ? !0 !== t && "number" != typeof t && t.effect || s : a;
                "number" == typeof(t = t || {}) && (t = {
                    duration: t
                }), n = !c.isEmptyObject(t), t.complete = i, t.delay && e.delay(t.delay), n && c.effects && c.effects.effect[r] ? e[a](t) : r !== a && e[r] ? e[r](t.duration, t.easing, i) : e.queue(function(t) {
